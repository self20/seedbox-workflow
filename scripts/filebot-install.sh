...
echo -e "system.method.set_key=event.download.finished,filebot_amc,\"execute={/home/$usersickrage/rtorrent-postprocess,\$d.get_base_path=,\$d.get_name=,\$d.get_custom1=}\"" >> /home/$usersickrage/.rtorrent.rc
